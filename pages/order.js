        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
              ...
              <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">Order Id: #73728</h1>
              <p className="leading-relaxed mb-4">Your Order has been successfully placed. Your payment status is: </p>
              ...
              <div className="flex border-t border-gray-200 py-2 items-center">
                <span className="text-gray-500 flex">Upgrade Your Home</span>
                <span className="m-auto text-gray-900">1</span>
                <span className="m-auto text-gray-900">₹99</span>
              </div>
              <div className="flex border-t border-gray-200 py-2 items-center">
                <span className="text-gray-500 flex">Upgrade Your Home</span>
                <span className="m-auto text-gray-900">1</span>
            ...
            <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded shadow-2xl" src="/order.jpg" />
          </div>
        </div>
      </section>
    </>
