...
const FamileyClick = () => {
    return (
        <>
            <div className='text-4xl font-semibold justify-normal flex-auto mt-20 ml-10'>🖤 "KSHIANKI® Familey Clicks"</div>
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
                        <div className="p-4 md:w-1/3 sm:mb-0 mb-6 ">
                            <div className="rounded-lg h-64 overflow-hidden border border-gray-400">
                                <img alt="content" className="object-cover object-center h-full w-full" src="/red.jpg"/>
                            </div>
                        ...
                        <div className="p-4 md:w-1/3 sm:mb-0 mb-6 ">
                            <div className="rounded-lg h-64 overflow-hidden border border-gray-400">
                                <img alt="content" className="object-cover object-center h-full w-full" src="/orange.jpg"/>
                            </div>
                        ...
                        <div className="p-4 md:w-1/3 sm:mb-0 mb-6 ">
                            <div className="rounded-lg h-64 overflow-hidden border border-gray-400">
                                <img alt="content" className="object-cover object-center h-full w-full" src="/yellow.jpg"/>
                            </div>
            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
                        <div className="p-4 md:w-1/3 sm:mb-0 mb-6 ">
                            <div className="rounded-lg h-64 overflow-hidden border border-gray-400">
                                <img alt="content" className="object-cover object-center h-full w-full" src="/green.jpg"/>
                            </div>
                        ...
                        <div className="p-4 md:w-1/3 sm:mb-0 mb-6 ">
                            <div className="rounded-lg h-64 overflow-hidden border border-gray-400">
                                <img alt="content" className="object-cover object-center h-full w-full" src="/blue.jpg"/>
                            </div>
                        ...
                        <div className="p-4 md:w-1/3 sm:mb-0 mb-6 ">
                            <div className="rounded-lg h-64 overflow-hidden border border-gray-400">
                                <img alt="content" className="object-cover object-center h-full w-full" src="/violet.jpg"/>
                            </div>
