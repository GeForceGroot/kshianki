            ...
            <section className="text-gray-600 body-font overflow-hidden">
                ...
                <div className="container px-5 py-16 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto  object-cover object-center rounded shadow-xl" src="/product.jpg" />
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            <h2 className="text-sm title-font text-gray-500 tracking-widest">KSHIANKI®</h2>
                            <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Upgrade Your Home (Blue)</h1>
