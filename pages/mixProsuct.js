...
const MixProsuct = () => {
    return (
        <>
            <div className='text-4xl font-semibold justify-normal flex-auto mt-10'>🖤 Turkish Style 100% Pure Cotton Towles</div>
            <div className='h-auto bg-gradient-to-r from-pink-50 to-pink-300 mt-10'>
                <section class="text-gray-600 body-font">
                    <div class="container px-5 py-24 mx-auto flex flex-wrap">
                        <div class="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
                            <img alt="feature" class="object-cover object-center h-full w-full" src="/backgroound.jpg" />
                        </div>
